...
fn normalize_vector(x f64, y f64) trnsfrm2d.Vector {
	return trnsfrm2d.normalize_vector(trnsfrm2d.Vector{x, y})
}

fn check_if_vector_values_expected(result_vector trnsfrm2d.Vector, expected_x f64, expected_y f64) {
	assert result_vector == trnsfrm2d.Vector{expected_x, expected_y}
}
